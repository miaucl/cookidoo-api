...
Defines recipe search via Cookidoo's Algolia backend, covering search token management, keyword queries, faceted filtering, sort orders, paginated results, and market-aware index selection.
